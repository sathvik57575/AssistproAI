    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-8 text-slate-700'>
        ...
        <form className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200 space-y-6' onSubmit={handleSubmit}>
            ...
            <div className='flex items-center gap-3'>
              ...
              <h1 className='text-xl font-medium'>AI Resume Review</h1>
            </div>

            <label htmlFor="topic" className='text-sm font-medium'>Upload Resume</label> 
            ...
            <p className='text-xs text-gray-500 font-light -mt-4'>Supports PDF, PNG, and other JPG formats (JPEG too)</p>

            <button disabled = {loading} className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#00DA83] to-[#009BB3] text-white px-4 py-2 mt-10 text-sm rounded-lg cursor-pointer'>
              {
